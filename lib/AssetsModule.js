...
class Assetsmodule extends AbstractApiModule {
  ...
  async localDelete(...args) { this.getRepo('local').delete(...args, this.localOpts); }
  async localEnsureDir(...args) { this.getRepo('local').ensureDir(...args, this.localOpts); }
  async localExists(...args) { this.getRepo('local').ensureExists(...args, this.localOpts); }
  async localRead(...args) { this.getRepo('local').read(...args, this.localOpts); }
  async localResolve(...args) { this.getRepo('local').resolvePath(...args, this.localOpts); }
  /** @override */
  async init() {
    await super.init();
